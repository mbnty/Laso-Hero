...
void textureLoader::multiTexGen(int AmountOfTextures, GLuint& texID)
{
    //glGenTextures(AmountOfTextures, texID);
}

void textureLoader::arrayTexLoader(char* fileName, GLuint& textureID)
{
    glBindTexture(GL_TEXTURE_2D, textureID);
